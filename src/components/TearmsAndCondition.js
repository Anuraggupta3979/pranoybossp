...
function TearmsAndCondition() {
  return (
    <div className="tearmsandc">
      ...
      <h6 className="headingH6">OVERVIEW</h6>
      <p className="teramspera">
        This website is operated by Earthy workshop & Co Pty Ltd. Throughout the
        site, the terms “we”, “us” and “our” refer to Earthy workshop & Co Pty
        Ltd. Earthy workshop & Co Pty Ltd offers this website, including all
     ...
     <p className="teramspera">
      ...
      <h6 className="headingH6">SECTION 1 – ONLINE STORE TERMS</h6>
     <p className="teramspera">
     ...
     <p className="teramspera">
      ...
      <h6 className="headingH6">SECTION 2 – GENERAL CONDITIONS</h6>
     <p className="teramspera">
     ...
     <p className="teramspera">
      ...
      <h6 className="headingH6">SECTION 3 – ACCURACY, COMPLETENESS, AND TIMELINESS OF INFORMATION</h6>
     <p className="teramspera">
     ...
     <p className="teramspera">
      ...
      <h6 className="headingH6">SECTION 4 – MODIFICATIONS TO THE SERVICE AND PRICES</h6>
     <p className="teramspera">Prices for our products are subject to change without notice.</p>
     <p className="teramspera">
     ...
     <p className="teramspera">
      ...
      <h6 className="headingH6">SECTION 5 – PRODUCTS OR SERVICES (if applicable)</h6>
     <p className="teramspera">
